...
with open(path_association+"/Disease-Hpo/"+"hpo2disease2021transfer.json") as fp:
...
path_result="../../../src/utils/DiseaseRankResult/finally"
with open(path_result+"/"+"BASE_IC_disease_result.json", "w") as fp:
    json.dump(diease_to_protein, fp, indent=2)
    # json.dump(combined_annotation, fp, indent=2)
